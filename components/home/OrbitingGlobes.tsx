...
interface Orbiter {
  ...
  /** Mobile-only anchor: pinned to top or bottom of the hero on small screens. */
  mobileAnchor: "top" | "bottom";
}

const ORBITERS: Orbiter[] = [
  { href: "/my-world", label: "My World", startAngleDeg: 0, mobileAnchor: "top" },
  { href: "/the-world", label: "The World", startAngleDeg: 180, mobileAnchor: "bottom" },
];
    ...
    <div className="orbit-stage absolute inset-0 pointer-events-none">
      ...
      <div className="orbit-shell">
        {ORBITERS.map((o) => (
          <div
            key={o.href}
            className={`orbit-slot orbit-slot--${o.mobileAnchor}`}
            style={
