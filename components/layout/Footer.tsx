      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
          ...
          <div>
            ...
            <p className="font-sans text-[13px] leading-relaxed text-muted-foreground">
              ...
              Designed by <a href="https://www.auto-ascent.us" target="_blank" rel="noopener noreferrer" className="text-[#00FF00] hover:underline">Auto Ascent</a>
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          ...
          <p className="font-sans text-[13px] text-muted-foreground mt-1">
            Five lanes of signal. Zero noise. Made by <a href="https://www.auto-ascent.us" target="_blank" rel="noopener noreferrer" className="text-[#00FF00] hover:underline">Auto Ascent</a>    &copy; {year}
          </p>
        </div>
      </div>
    </footer>
